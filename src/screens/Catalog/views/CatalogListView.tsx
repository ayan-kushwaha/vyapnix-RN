...
import { MoreVertical, Search, SlidersHorizontal, Plus, SwatchBook } from 'lucide-react-native';
...
interface CatalogListViewProps {
    ...
    onNavigateToUpdateTemplate: (template: ItemTemplate) => void; // ✅ Prop yahan hai
...
export const CatalogListView: React.FC<CatalogListViewProps> = ({
    onNavigateToChooseTemplate, onNavigateToAddTemplate, onNavigateToEditTemplate,
    onNavigateToUpdateTemplate, onNavigateToAddItem, onNavigateToEditItem,
    onNavigateToTaxManagement, onNavigateToItemDetail
}) => {
    ...
    useEffect(() => { dispatch(getMyTemplates()); dispatch(getMyItems()); }, [dispatch]);
    ...
    const menuActions = [
        { title: "Choose Starter Template", icon: SwatchBook, onPress: onNavigateToChooseTemplate },
            ...
            <FlatList
                ...
                renderItem={({ item }) => (
                    <TemplateCard
                        ...
                        onNavigateToUpdate={onNavigateToUpdateTemplate} // ✅ Prop aage pass ho raha hai
                    />
                )}
