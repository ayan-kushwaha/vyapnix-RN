    ...
    return (
        <SafeAreaView style={[tw`flex-1`, { backgroundColor: theme.colors.background }]}>
            ...
            <ScrollView contentContainerStyle={tw`p-6 pb-20`} keyboardShouldPersistTaps="handled">
                ...
                <SearchableDropdown mode="multiple" label={t.modelType} data={[{ label: 'E-commerce', value: 'e-commerce' }, { label: 'Booking', value: 'booking' }, { label: 'Subscription', value: 'subscription' }]} value={formData.modelType} onSelectionChange={val => setFormData(p => ({ ...p, modelType: val as any }))} />
                <View style={tw`mt-6`}>
                ...
                <TouchableOpacity
                    ...
                    disabled={isLoading}
                    style={[
                        tw`mt-8 h-14 rounded-xl items-center justify-center`,
                        { backgroundColor: theme.colors.primary as string, opacity: isLoading ? 0.7 : 1 }
                    ]}
                >
                    {isLoading ? (
